...
@Getter
public class DayUseReservation extends Reservation{
    ...
    public DayUseReservation(User guest, String contractorName, String phone, Room room,
    ...
    public DayUseReservation(DayUseReservation.builder builder) {
    ...
    public static class builder extends Reservation.builder{
        ...
        public DayUseReservation build(){
            return new DayUseReservation(this);
        }
    }
}
